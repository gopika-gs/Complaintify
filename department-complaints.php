	...
	<body>
        ...
        <section class="page-top-section set-bg" data-setbg="images/page-top-bg/4.jpg" style="background-image: url(&quot;img/page-top-bg/4.jpg&quot;);">
            <div class="container">
                ...
                <nav class="site-breadcrumb">
                    ...
                    <span class="sb-item active">Department Complaints</span>
                </nav>
            </div>
        </section>
        ...
        <section class="elements-section pt-5 pb-5">
		    <div class="container" style="padding-bottom: 135px;">
                <h2 class="el-title" style="font-weight: 700;">Department Complaints</h2>

                <?php if(isset($_GET["status"])) if($_GET["status"]=="success"){ ?>
                    <div class="blog-date">Compalint has been closed</div>
                <?php } ?>

                <br>

                <?php
                    $complaints = $db->where('locality_id', get_user_model()['locality_id'])->where('status', 0)->get("complaints");
                    if ($db->count > 0){
                ...
                ?>
                        ...
                        <div class="complaint-card">
                            <div class="row">
                                <div class="col">
                                    <a href="department-view-complaint.php?id=<?php echo $complaint['id']; ?>"><h5 class="card-title"><?php echo ucfirst($complaint['subject']); ?></h5></a>
                                    <p style="margin: 0px; margin-bottom: 16px;">Published on <?php echo $complaint['timestamp']; ?></p>
                                </div>
                                <div class="col-md-auto">
                                    <a href="department-view-complaint.php?id=<?php echo $complaint['id']; ?>"><div class="blog-date" style="margin: 0px;">View details</div></a>
                                </div>
                            </div>
                        </div>
